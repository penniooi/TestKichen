...
public let kScreenHight = UIScreen.mainScreen().bounds.size.height
...
//评论发送
public let kAdDetailCommentUrl = ("http://api.izhangchu.com/?appVersion=4.5&sysVersion=9.3.2&devModel=iPhone")
...
//2、食材
public let kFoodHomeUrl  =  ("http://api.izhangchu.com/?appVersion=4.5&sysVersion=9.3.2&devModel=iPhone")
...
//3、分类
public let kCategoryHomeUrl = ("http://api.izhangchu.com/?appVersion=4.5&sysVersion=9.3.2&devModel=iPhone")
...
//注册
//获取验证码
public let kVerifyUrl = ("http://api.izhangchu.com/?appVersion=4.5&sysVersion=9.3.2&devModel=iPhone")
//device_id=021fc7f7528&methodName=UserLogin&mobile=13716422377&token=&user_id=&version=4.32


public let kRegisterVerUrl = ("http://api.izhangchu.com/?appVersion=4.5&sysVersion=9.3.2&devModel=iPhone")
...
//注册
public let kRegisterUrl = ("http://api.izhangchu.com/?appVersion=4.5&sysVersion=9.3.2&devModel=iPhone")
